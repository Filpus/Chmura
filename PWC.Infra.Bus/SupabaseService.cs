...
namespace PWC.Infra.Bus
{
    public class SupabaseService<T> where T : BaseModel, new()
    {
        ...
        public SupabaseService(string url = "https://mbzcixmvfpzqsmfowedr.supabase.co", string key = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im1iemNpeG12ZnB6cXNtZm93ZWRyIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc0MzYyNDkwNSwiZXhwIjoyMDU5MjAwOTA1fQ.1jskfRdtUmFfJKjNdAIR3HPgxvsCJnDuycNId4s2mNg")
        {
